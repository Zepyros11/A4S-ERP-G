...
(function () {
  ...
  const MENU = [
    ...
    // **************** EVENT *****************
    {
      ...
      items: [
        ...
        {
          id: "attendee-templates",
          icon: "📋",
          label: "เทมเพลตฟอร์มลงทะเบียน",
        ...
        },
        {
          id: "survey-forms",
          icon: "📝",
          label: "แบบประเมินความพอใจ",
          path: BASE_PATH + "/modules/event/survey-forms.html",
          section: "setup",
        },
        {
    ...
    //  **************** STOCK *****************
    {
      ...
      items: [
        ...
        },
        {
          id: "stock-check",
          icon: "🧮",
          label: "ตรวจนับ Stock F.3",
          path: BASE_PATH + "/modules/inventory/stock-check.html",
        },
        {
          id: "withdraw",
          icon: "📤",
          label: "เบิกสินค้า",
          path: BASE_PATH + "/modules/inventory/withdraw.html",
        },
        {
          id: "borrow-return",
          icon: "🔁",
          label: "ยืม / คืน สินค้า",
          path: BASE_PATH + "/modules/inventory/borrow-return.html",
        },
        {
          id: "delivery-tracking",
          icon: "🚚",
          label: "Order Tracking",
          path: BASE_PATH + "/modules/inventory/delivery-tracking.html",
        },
        /* ── SETUP items ── */
        {
          id: "categories",
  ...
  const ID_TO_PERM = {
    ...
    "attendee-templates": "attendee_view",
    "survey-forms": "events_view",
    ...
    "delivery-tracking": "delivery_view",
    "borrow-return": "borrow_view",
    withdraw: "withdraw_view",
    "stock-balance": "product_view",
    "stock-check": "stock_check_view",
