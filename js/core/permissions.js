  ...
  const modules = [
    ...
    /* ── 4. คลังสินค้า (STOCK) ── */
    {
      ...
      children: [
        ...
        { key: "delivery", label: "Order Tracking", icon: "🚚", perms: [
          { key: "delivery_view",   label: "ดูรายการ" },
          { key: "delivery_create", label: "เพิ่มรายการ" },
          { key: "delivery_edit",   label: "แก้ไข / ติ๊กส่ง Track" },
          { key: "delivery_delete", label: "ลบ" },
        ]},
        { key: "borrow", label: "ยืม / คืน สินค้า", icon: "🔁", perms: [
          { key: "borrow_view",   label: "ดูรายการ / รายงาน" },
          { key: "borrow_create", label: "บันทึกยืม-คืน" },
          { key: "borrow_edit",   label: "แก้ไข" },
          { key: "borrow_delete", label: "ลบ" },
        ]},
        { key: "withdraw", label: "เบิกสินค้า", icon: "📤", perms: [
          { key: "withdraw_view",   label: "ดูรายการ / รายงาน" },
          { key: "withdraw_create", label: "บันทึกเบิก" },
          { key: "withdraw_edit",   label: "แก้ไข / ตั้งค่ารายการ" },
          { key: "withdraw_delete", label: "ลบ" },
        ]},
        { key: "stock_check", label: "ตรวจนับสต็อก", icon: "🧮", perms: [
          { key: "stock_check_view",   label: "ดูใบตรวจนับ" },
          { key: "stock_check_create", label: "เปิดรอบตรวจนับ" },
          { key: "stock_check_edit",   label: "กรอก / ดึงยอด / ปิดรอบ" },
          { key: "stock_check_delete", label: "ลบรอบ / ลบรายการ" },
          /* แยกจาก stock_check_edit เพราะกระทบ 3 หน้าพร้อมกัน (ตรวจนับ · เบิก · ยืม/คืน)
             คนกรอกใบตรวจนับไม่ควรแก้ master ที่หน้าอื่นใช้อยู่ไปด้วยโดยอัตโนมัติ */
          { key: "stock_items_manage", label: "จัดการรายการสินค้ากลาง (ใช้ร่วม 3 หน้า)" },
        ]},
  ...
  const defaultRoles = {
    ...
    MANAGER: {
      ...
      perms: [
        ...
        "withdraw_view","withdraw_create","withdraw_edit","withdraw_delete",
        "delivery_view","delivery_create","delivery_edit","delivery_delete",
        "borrow_view","borrow_create","borrow_edit","borrow_delete",
        "stock_check_view","stock_check_create","stock_check_edit","stock_check_delete","stock_items_manage",
    ...
    WAREHOUSE: {
      ...
      perms: [
        ...
        "withdraw_view","withdraw_create","withdraw_edit",
        "stock_check_view","stock_check_create","stock_check_edit","stock_items_manage",
