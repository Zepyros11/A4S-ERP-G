    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          icon: "✏️",
          label: "จัดการสินค้า",
          path: "/A4S-ERP-G/stock_adjustment.html",
        },
        {
          id: "stock-move",
          icon: "🔄",
      ...
      items: [
        {
          ...
          icon: "🛒",
          label: "ใบสั่งซื้อ (PO)",
          path: "/A4S-ERP-G/document/po_form.html",
        },
        {
          id: "so",
          icon: "💰",
          label: "ใบขาย (SO)",
          path: "/A4S-ERP-G/document/so_form.html",
        },
        {
          id: "req",
          icon: "📋",
          label: "ใบเบิก (REQ)",
          path: "/A4S-ERP-G/document/requisition.html",
        },
      ],
    },
    {
      ...
      items: [
        {
          ...
          icon: "📈",
          label: "รายงาน Stock",
          path: "/A4S-ERP-G/report/reports.html",
        },
      ],
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          icon: "👥",
          label: "ผู้ใช้งาน",
          path: "/A4S-ERP-G/settings/users.html",
        },
        {
          id: "suppliers",
          icon: "🚚",
          label: "Supplier",
          path: "/A4S-ERP-G/settings/suppliers.html",
        },
        {
          id: "customers",
          icon: "🧑",
          label: "ลูกค้า",
          path: "/A4S-ERP-G/settings/customers.html",
        },
      ],
    },
  ];
