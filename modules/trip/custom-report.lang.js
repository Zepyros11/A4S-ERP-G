...
I18n.register({
  ...
  "cr.file.has":           { th: "📄 มีไฟล์", en: "📄 Has file" },
  "cr.file.none":          { th: "ไม่มีไฟล์", en: "No file" },
  "cr.pdf.open":           { th: "📄 PDF", en: "📄 PDF" },
  "cr.pdf.openTip":        { th: "เปิดไฟล์ PDF ในแท็บใหม่", en: "Open PDF file in a new tab" },
  ...
  "cr.col.instead":            { th: "ชื่อคนไปแทน", en: "Substitute" },
  ...
  "cr.col.visa_pdf_url":       { th: "วีซ่า (PDF)", en: "Visa (PDF)" },
  "cr.col.visa_image_url":     { th: "สลิป", en: "Slip" },
  "cr.col.paid":               { th: "ชำระ (Paid)", en: "Paid" },
  "cr.col.waive":              { th: "ยกเว้น (Waive)", en: "Waive" },
  ...
  "cr.col._fldep":             { th: "ขาไป - เวลาออก", en: "Outbound - departure" },
  "cr.col._flarr":             { th: "ขาไป - เวลาถึง", en: "Outbound - arrival" },
  "cr.col._flcomeback":        { th: "Flight (ขากลับ)", en: "Flight (return)" },
  "cr.col._flcomebackdt":      { th: "ขากลับ - ออก", en: "Return - departure" },
