...
>
> **ฉบับเต็มสำหรับคนที่เห็นโค้ดจริง (implementer / โปรเจกต์อื่นที่จะลอกไปใช้) = [WEBSITE-BUILDER-SYSTEM.md](WEBSITE-BUILDER-SYSTEM.md)**
> ไฟล์นี้ = สรุปสั้นไว้เขียน task · ไฟล์นั้น = อธิบายทุกกลไก + กับดัก + วิธีต่อยอด
